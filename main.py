...
def main():
    ...
    image_prompt += "come up with a detailed description of an image for each slide that accommodates what the description is talking about. Provide the output in the format: Give the list of slides in the format: Slide 1: [image description], Slide 2: [image description]."
